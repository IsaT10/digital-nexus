...
const ProductCard = ({
  product: { _id, price, type, image, rating, name, brandName },
}) => {
  return (
    <div>
              ...
              <div className="flex-auto p-4 justify-evenly">
                <div className="flex justify-between items-center">
                  <div className=" flex-none text-sm flex items-center text-gray-600">
                    ...
                    <span className="text-gray-400 font-semibold whitespace-nowrap mr-3">
                      {rating}
                    </span>
                  </div>
                  <p className="flex items-center bg-secondary-color text-xs px-2 py-0.5 ml-3 uppercase font-bold text-primary-color rounded-full">
                    {type}
                  </p>
                </div>
                <div className="flex justify-between items-center mt-4">
                  <div>
                    <h2 className="text-lg mr-auto text-gray-200  truncate ">
                      {name}
                    </h2>
                  ...
                  <div className="flex  space-x-2 text-sm font-medium items-center justify-between">
                    <div className="flex items-center flex-col  gap-2">
                      ...
                      >
                        <BsFillCartFill className="text-2xl text-secondary-color duration-200 cursor-pointer " />
                      </div>
                    </div>
                  </div>
                </div>
