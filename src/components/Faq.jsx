  ...
  return (
    <div className="lg:flex justify-between items-start gap-4 my-10 md:my-28">
      <div className="join join-vertical mx-11 flex flex-col items-center justify-center">
        <h3 className="text-4xl text-stone-300">FAQ</h3>
        <div className="collapse collapse-arrow join-item ">
          <input type="radio" name="my-accordion-4" />
          <div className="collapse-title text-xl font-medium flex gap-3">
            <span className="tracking-widest text-stone-300">01</span>
          ...
          <div className="collapse-content">
            <p className="border-t-[1px] border-stone-600 rounded-none pt-2 md:text-lg text-sm text-stone-400 text-left">
        ...
        <div className="collapse collapse-arrow join-item ">
          <input type="radio" name="my-accordion-4" />
          <div className="collapse-title text-xl font-medium flex gap-3">
            <span className="tracking-widest text-stone-300">02</span>
            <span className="text-stone-800 hover:text-stone-300 text-left">
        ...
        <div className="collapse collapse-arrow join-item ">
          <input type="radio" name="my-accordion-4" />
          <div className="collapse-title text-xl font-medium flex gap-3">
            <span className="tracking-widest text-stone-300">03</span>
            <span className="text-stone-800 hover:text-stone-300 text-left">
        ...
        <div className="collapse collapse-arrow join-item ">
          <input type="radio" name="my-accordion-4" />
          <div className="collapse-title text-xl font-medium flex gap-3">
            <span className="tracking-widest text-stone-300">04</span>
            <span className="text-stone-800 hover:text-stone-300 text-left">
        ...
        <div className="collapse collapse-arrow join-item ">
          <input type="radio" name="my-accordion-4" />
          <div className="collapse-title text-xl font-medium flex gap-3">
            <span className="tracking-widest text-stone-300">05</span>
            <span className="text-stone-800 hover:text-stone-300 text-left">
              How do I troubleshoot common tech issues at home?
            </span>
          </div>
          <div className="collapse-content">
            <p className="border-t-[1px] border-stone-600 rounded-none pt-2 md:text-lg text-stone-400 text-left text-sm">
